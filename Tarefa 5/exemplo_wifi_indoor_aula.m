...
% ------------------------------------------------------------------------------------------------------
% Defini��o da �rea de Cobertura (em pixels)
% ------------------------------------------------------------------------------------------------------
...
% ------------------------------------------------------------------------------------------------------
% Defini��es das Paredes em Metros - Escala de 10 pixels/metro
% ------------------------------------------------------------------------------------------------------
% Paredes horizontais
...
% Exemplo com 1 Obstru��o
% x_ap=10;   y_ap=45;
% x=30;          y=35;

% Exemplo com 2 Obstru��es
% x_ap=10;   y_ap=45;
% x=40;          y=35;

% Exemplo com 3 Obstru��es
%x_ap=10;   y_ap=45;
%x=40;          y=15;
...
for i=1:step_grid:length(y)
    for j=1:step_grid:length(x)
        ...
        % Perda Total das Obstru��es (Paredes) - 6dB/parede de tijolos
        PL_Wall_dB=6.*number_of_obstructions;


        % ----------------------------------------------------------------
        % Pot�ncias Recebidas para d<d0
        % ----------------------------------------------------------------
        if (d>d0)
...
% -----------------------------------------------------------------
% Ajuste de Zeros na Matriz de Pot�ncia e Taxa
% -----------------------------------------------------------------
for i=1:length(y)
